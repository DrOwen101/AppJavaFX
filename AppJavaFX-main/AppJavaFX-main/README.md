...
Me (Connor McGee), Benjamin Lukens, and WesLee Williams participated and voted on mine to be pushed to main.
The lesson we learned CSS files are very useful and predominant + how different people can think about different colors being better options (it requires multiple sources to make the UI more friendly to users).
